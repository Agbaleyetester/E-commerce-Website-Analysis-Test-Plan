...
Your chosen E-commerce site: https://www.saucedemo.com/ (This is a well-known demo site specifically for practicing automation.)
...
User enters valid credentials ("standard_user", "secret_sauce") and clicks "Login".
User adds the "Sauce Labs Backpack" to the cart.
User clicks the shopping cart icon.
User clicks "Checkout".
User fills in their information (First Name, Last Name, Zip Code).
User clicks "Continue".
User clicks "Finish".
User sees the "Thank you for your order!" confirmation message.
